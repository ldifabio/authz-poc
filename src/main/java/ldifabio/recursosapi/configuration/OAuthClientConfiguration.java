package ldifabio.recursosapi.configuration;
...
public class OAuthClientConfiguration {
    // Create the KC client registration
    @Bean
    ClientRegistration kcClientRegistration(
    ...
    @Bean
    public ClientRegistrationRepository clientRegistrationRepository(ClientRegistration kcClientRegistration) {
        return new InMemoryClientRegistrationRepository(kcClientRegistration);
    }
